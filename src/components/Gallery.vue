...
export default {
  data () {
    return {
      ...
      images: ['./static/imgs/hilary1.jpg', './static/imgs/person3.jpg', './static/imgs/person1.jpg', './static/imgs/store1.jpg', './static/imgs/couple.jpg', './static/imgs/dudes.jpg', './static/imgs/person2.jpg'],
      currentImage: 0
    }
  },
  methods: {
