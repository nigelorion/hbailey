...
export default {
  ...
  data () {
    return {
      ...
      images: ['./static/imgs/hilary1.jpg', './static/imgs/jackets3.jpg', './static/imgs/misc.jpg', './static/imgs/timAlley.jpg', './static/imgs/drawing.jpg', './static/imgs/woman1.jpg', './static/imgs/dude1.jpg'],
      currentImage: 0
    }
  },
  methods: {
